...
function resetStore() {
  ...
  useKoma.setState((s) => ({
    ...
    settingsValues: {
      ...
      subagentMaxTurns: 500, shortSendEngageN: 80, shortSendTailN: 40,
    },
...
// ── TEST 15: SettingsValues prunes using canonical availableRoots
{
  ...
  useKoma.getState().push({ k: 'SettingsValues', name: 'test', workdir: ['/ws/a'], shortSend: false, slidingCache: false, bashSaving: false, codingAutosave: false, internetMode: 'simple', palette: 'dark', effort: '', subagentMaxTurns: 500, shortSendEngageN: 80, shortSendTailN: 40 })
  const s = useKoma.getState().importGraph
