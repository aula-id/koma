...
export const Route = createFileRoute('/_docs/welcome/architecture')({
...
function Architecture() {
  return (
    <article>
      <h1 className="mb-4 text-2xl font-normal text-koma-fg">Architecture</h1>
      ...
      <h2 className="mb-2 mt-6 text-lg font-normal text-koma-fg">Components</h2>
