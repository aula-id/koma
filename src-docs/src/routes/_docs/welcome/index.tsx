  ...
  return (
    <article>
      ...
      <ul className="space-y-2 text-koma-fg">
        ...
        <li>
          <Link to="/tui" className="text-koma-accent hover:underline">
            TUI Commands
          </Link>{' '}
          — every slash command, with live terminal tutorials.
        </li>
        <li>
          <Link to="/tui/keyboard-shortcuts" className="text-koma-accent hover:underline">
            Keyboard Shortcuts
          </Link>{' '}
          — the full key map.
        </li>
        <li>
          <Link to="/tui/settings-oauth" className="text-koma-accent hover:underline">
            OAuth &amp; Providers
          </Link>{' '}
          — connect koma.run, Codex, Claude, and more.
        </li>
        <li>
          <Link to="/gui" className="text-koma-accent hover:underline">
            Desktop GUI
          </Link>{' '}
          — run koma in a native webview window.
        </li>
        <li>
          <Link to="/welcome/architecture" className="text-koma-accent hover:underline">
            Architecture
          </Link>{' '}
          — how koma is built.
        </li>
